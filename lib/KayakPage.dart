    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.only(left: 45.0, right: 45.0, top: 40.0),
            child: Container(
              height: 50.0,
              child: Row(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text(
                'We start at the kayak base at port and paddle past the Homlong Bay and towards the point where you can see the waterfall.',
                style: TextStyle(
                  fontFamily: 'Inconsolata',
                  fontSize: 18.0,
